...
function StruttureClient() {
  ...
  return (
    <Container className="my-5">
      <h2 className="headLine text-center mb-5 fw-bold text-uppercase">
        Le Nostre Strutture
      </h2>
            ...
            <Card className="h-100 border-0 shadow-sm overflow-hidden hover-shadow transition">
              ...
              <Card.Body>
                ...
                <Card.Text className="text-muted small">
                  <GeoAlt className="bodyCopy me-1" /> {s.località.città},{" "}
                  {s.località.indirizzo}
                </Card.Text>

                <Card.Text className="bodyCopy">{s.descrizione}</Card.Text>
              </Card.Body>
